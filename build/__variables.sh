...
declare -r BUILD_IMAGES_NO_PLATFORMS_DOCKERFILE="$__REPO_DIR/images/build/noPlatforms.Dockerfile"
...
declare -r ORYXTESTS_NO_PLATFORMS_BUILDIMAGE_DOCKERFILE="$__REPO_DIR/tests/images/build/noPlatforms.Dockerfile"
...
declare -r ORYXTESTS_NO_PLATFORMS_BUILDIMAGE_REPO="oryxtests/build-no-platforms"

declare -r DEVBOX_BUILD_IMAGES_REPO="oryx/build"
declare -r DEVBOX_SLIM_BUILD_IMAGE_REPO="oryx/build-slim"
declare -r DEVBOX_NO_PLATFORMS_BUILD_IMAGE_REPO="oryx/build-no-platforms"
...
declare -r ACR_NO_PLATFORMS_BUILD_IMAGE_REPO="$ACR_DEV_NAME/public/oryx/build-no-platforms"
