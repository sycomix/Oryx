...
namespace Microsoft.Oryx.BuildScriptGenerator.Php
{
    internal class PhpConstants
    {
        ...
        internal const string BuiltInPhpInstallVersionsDir = "/opt/php/"; // TODO: consolidate with Dockerfile to yaml?
        internal const string DynamicPhpInstallVersionsDir = "/tmp/oryx/php/";
    }
}
